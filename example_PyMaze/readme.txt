<note from mjrb>
i stole this code from the examples page on pygame's website
you can look at the RestartMaze.py and TwitchMaze.py to see how I
modified the game for wtitch plays. the rest of this readme is from the original author
i had to also modify the original game so that it would restart when you hit the goal.

games that restart automatically or last a while and are more turn based/grid based make things easier.
</note from mjrb>
