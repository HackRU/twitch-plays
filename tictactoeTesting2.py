...
import time
import threading
from twitchPlays import twitchPlaysOnline, twitchPlaysOffline
...
run = True
won = False
options = ["1","2","3","4","5","6","7","8","9","reset"]
tPlays = twitchPlaysOnline("irc.twitch.tv", 6667, "oauth:342unb3xh4k4ui5vms06ckdbqyu22b", "TwitchBot", "fungster", "fungster")
playerChoice = None
getVotes(tPlays)
...
while run:
    ...
    if won != True:
        if playerChoice == "1" and first_open:
        ...
        if playerChoice == "2" and second_open:
            if draw_object == 'circle':
        ...
        if playerChoice == "3" and third_open:
            if draw_object == 'circle':
        ...
        if playerChoice == "4" and fourth_open:
            if draw_object == 'circle':
        ...
        if playerChoice == "5" and fifth_open:
            if draw_object == 'circle':
        ...
        if playerChoice == "6" and sixth_open:
            if draw_object == 'circle':
        ...
        if playerChoice == "7" and seventh_open:
            if draw_object == 'circle':
        ...
        if playerChoice == "8" and eighth_open:
            if draw_object == 'circle':
        ...
        if playerChoice == "9" and ninth_open:
            if draw_object == 'circle':
